# sda or nvme0n1
# password gen 
#	perl -e 'print crypt("smc123","\$6\$saltsalt\$") . "\n"'
#	python3 -c "import crypt, getpass, pwd; print(crypt.crypt('smc123', '\$6\$SALTsalt\$'))"
...
UUID_O2=$(head -n 1 ${PT1}/EFI/${OSVER}/grub.cfg | awk '{print $2}')
...
sed -i "s/${UUID_O2}/${UUID_N2}/g" ${PT1}/EFI/${OSVER}/grub.cfg
sed -i "s/${UUID_O2}/${UUID_N2}/g" ${PT1}/EFI/${OSVER}/grub.cfg.rpmsave

sed -i "s/${UUID_O2}/${UUID_N2}/g" ${PT2}/boot/loader/entries/*

sed -i "s/${UUID_O2}/${UUID_N2}/g" ${PT2}/boot/grub2/grub.cfg
sed -i "s/${UUID_O2}/${UUID_N2}/g" ${PT2}/etc/fstab
sed -i "s/${UUID_O1}/${UUID_N1}/g" ${PT2}/etc/fstab
sed -i "s/${UUID_O2}/${UUID_N2}/g" ${PT2}/etc/kernel/cmdline
...
# checking
grep $UUID_N2 ${PT1}/EFI/${OSVER}/grub.cfg >/dev/null
[[ $? -eq 0 ]] && echo "  grub.cfg  OK!" || echo "ERR"

grep $UUID_N2 ${PT1}/EFI/${OSVER}/grub.cfg.rpmsave >/dev/null
[[ $? -eq 0 ]] && echo "  rpmsave   OK!" || echo "ERR"

grep $UUID_N2 ${PT2}/boot/grub2/grub.cfg >/dev/null
